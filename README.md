...
<p align="center">
  <img src="screenshots/menubar.png" width="320" alt="Menu Bar Dropdown">
...
- **Start at Login** — optional auto-start via LaunchAgent
...
1. Download `SystemMonitor-1.0.2.dmg` from [Releases](https://github.com/zhxmarshall/macos-system-monitor/releases)
...
4. Remove auto-start: `rm -f ~/Library/LaunchAgents/com.local.systemmonitor.plist`
...
1. 从 [Releases](https://github.com/zhxmarshall/macos-system-monitor/releases) 下载 `SystemMonitor-1.0.2.dmg`
2. 双击打开 DMG 文件
...
4. 删除自启动：`rm -f ~/Library/LaunchAgents/com.local.systemmonitor.plist`
...
1. [Releases](https://github.com/zhxmarshall/macos-system-monitor/releases) から `SystemMonitor-1.0.2.dmg` をダウンロード
2. DMG をダブルクリックして開く
...
4. 自動起動削除：`rm -f ~/Library/LaunchAgents/com.local.systemmonitor.plist`
...
apple_metrics.py    → Apple Silicon data collectors (GPU / Temp / Power / Network)
```
...
├── apple_metrics.py     # Apple Silicon metrics (GPU, temp, power, network)
